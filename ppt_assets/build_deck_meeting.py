...
# ==================== 7 为什么增加数据：消除内容 OOD 假血管 ====================
s=slide(); motif_title(s,"为什么要增加数据：消除内容 OOD 的“假血管”",7)
...
bullets(s,7.6,5.18,5.2,2.1,[
    [("为什么加数据（关键）：",14,NAVY,True)],
    [("· 单被试模型在没见过的人手上",13,INK,False),("脑补出假血管",13,RED,True),("（内容OOD）;",13,INK,False)],
    [("· 内容 OOD 不是 NTN 的活，靠",13,INK,False),("数据多样性",13,MINT,True),("解决;",13,INK,False)],
    [("· 加多被试后：人脚 OOD 也忠实，36 噪声OOD场景 N2N≈NTN（−0.02dB）。",13,INK,False)],
],sz=13,gap=5)
